...
kubectl set image deployments/client-deployment client=trofimovichyury/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=trofimovichyury/multi-worker:$SHA